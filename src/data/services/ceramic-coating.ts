...
export const ceramicCoatingData: ServicePageData = {
  ...
  videos: [
    {
      ...
      src: "https://d8j0ntlcm91z4.cloudfront.net/user_3EVpSF8J7BYGcfrDJ4Z3bxfTn0C/hf_20260617_233053_3d16edac-d710-4c96-ad80-4a3eae18f5e2.mp4",
      poster: "/images/services/car-ceramic-1.jpg",
    },
    {
      label: "Inside The Process",
      src: "https://d8j0ntlcm91z4.cloudfront.net/user_3EVpSF8J7BYGcfrDJ4Z3bxfTn0C/hf_20260617_234350_af6cd9c6-d482-4387-a3c8-5cfa66e36447.mp4",
  ...
  included: [
    ...
    "Optional Add-On: Wheels, Trim, and Glass Coating: Complete exterior protection.",
    "Optional Add-On: Interior Ceramic Coating: Upgrade your experience! Protects leather, fabric, vinyl, and plastics from stains, spills, and UV fading, making interiors easier to clean and keeping them looking like new.",
  ...
  /* "Why Choose Front Range Detail Studio?" section from original */
  whyChoose: {
  ...
  /* "System X Ceramic Coating Benefits" as additional section */
  additionalSections: [
    {
      h2: "System X Ceramic Coating Benefits",
      body: "",
      items: [
        { title: "Long-Lasting Protection", body: "Our System X coatings provide years of durable defense against UV rays, chemicals, bird droppings, and environmental fallout." },
        { title: "Unmatched Hydrophobic Effect", body: "Water, dirt, and contaminants slide right off\u2014keeping your car cleaner between washes." },
        { title: "UV & Oxidation Resistance", body: "Protects your paint from fading and oxidation caused by Colorado\u2019s intense high-altitude sun." },
        { title: "Scratch & Chemical Resistance", body: "The hard ceramic layer resists light scratches, road salt, and chemical exposure." },
        { title: "Warranty-Backed", body: "All of our System X ceramic coating packages come with a manufacturer-backed warranty for your peace of mind." },
      ],
    },
    {
      ...
      body: "",
      items: [
        { title: "Thorough Hand Wash", body: "We start with a meticulous hand wash to remove surface dirt and debris." },
        { title: "Paint Decontamination", body: "Clay bar treatment and chemical decontamination remove embedded contaminants." },
        { title: "Paint Correction (If Needed)", body: "Multi-stage machine polishing to remove swirls, scratches, and imperfections." },
        { title: "Ceramic Coating Application", body: "Multiple layers of System X MAX G Plus applied by hand for even, durable coverage." },
        { title: "Curing", body: "Infrared curing in our climate-controlled studio for optimal bond strength." },
        { title: "Final Inspection", body: "Every inch inspected under specialized lighting before delivery." },
      ],
    },
  ],
  gallery: [
    { src: "/images/gallery/System-X-Top-Coat-vertical-pic.webp", alt: "SystemX TopCoat product on table Chevrolet car in the background" },
    { src: "/images/gallery/System-X-Max-G.webp", alt: "System X MAX G+ product" },
    { src: "/images/vehicles/toyota-suv-1024x768.jpg", alt: "Toyota SUV" },
    { src: "/images/gallery/BMW-vertical-pic-2.webp", alt: "BMW car detailing including paint protection film (PPF) or clear bra, window tinting, ceramic coating, vinyl wraps and more" },
    { src: "/images/gallery/BMW-i4-vertical-pic.webp", alt: "BMW car detailing including paint protection film (PPF) or clear bra, window tinting, ceramic coating, vinyl wraps and more" },
