  ...
  features: [
    {
      ...
      body: "Blocks the rays that fade interiors and damage skin on long Colorado drives.",
    },
    {
      title: "Up To 94% Heat Rejection",
      body: "Infrared-blocking ceramic keeps your cabin dramatically cooler in summer.",
    },
    {
      title: "Glare Reduction",
      body: "Cuts harsh winter glare and snow glare for safer, more comfortable driving.",
    },
    {
      title: "Signal-Friendly",
      body: "Non-metallic ceramic film won\u2019t interfere with GPS, phone or radio signals.",
    },
    {
