...
export const ppfData: ServicePageData = {
  ...
  included: [
    "Premium SunTek Reaction Paint Protection Film: Advanced self-healing, hydrophobic film designed for long-lasting protection.",
    "12-Year Manufacturer Warranty: Coverage against yellowing, cracking, peeling, and bubbling.",
    "Professional Installation in a Climate-Controlled Studio: Ensures a dust-free environment for flawless results.",
    "Complimentary Ceramic Boost Top Coat: Enhances gloss, slickness, and ease of cleaning.",
    "Wrapped Panel Edges Where Possible: Provides maximum coverage and a seamless finish.",
    "Personalized Aftercare Instructions: Guidance on maintaining your vehicle\u2019s new protection.",
  ],
  ...
  /* PPF Options section from the original site */
  additionalSections: [
    {
      h2: "PPF Options",
      body: "Whether you choose full body PPF for your show car exotic, or just a full front end clear bra for your daily driver, our technicians are equipped with the best tools, technology, and technical skills to ensure a top-tier installation. With quality and longevity as our goal, your vehicle\u2019s appearance will stand the test of time with our warranty backed paint protection film. Our arsenal of proven PPF brands offer you the luxury of protecting your ride while expressing your style. Choose from an invisible shield film to maintain your factory appearance, or spice things up with a matte paint protection film for a unique finish that turns heads. And if you are feeling particularly adventurous, Front Range Detail Studio offers a range of colored PPF to restyle your ride to the color of your dreams while adding a protective layer. From a sleek black PPF to a high gloss midnight purple clear bra, we are prepared for all your restyling and paint protection needs. Every paint protection film installation at Front Range Detail Studio comes with a ceramic coating application to preserve the appearance of the film with maximum shine and self-cleaning, dirt-repelling characteristics.",
    },
    {
