...
export const rivianDetailingData: VehiclePageData = {
  ...
  logoImg: "/images/logos/Rivian-white-logo.png",
  ...
  ppfImg: "/images/vehicles/Rivian-ppf.png",
  ppfH2: "Rivian Paint Protection Film Packages",
  ppfFeatures: [
    {
      title: "Custom-Fit Rivian-Specific PPF",
      body: "We apply premium, self-healing clear film designed to shield your Rivian’s paint from rock chips, scratches, road debris, and environmental damage without compromising gloss or clarity.",
    },
    {
      title: "Digital Precision Cutting",
      body: "Each install uses precision-cut patterns tailored to your Rivian’s exact body lines, from the front bumper and fascia to the wheel arches and tailgate.",
    },
    {
  ...
  ppfOptions: [
    ...
    },
    {
      ...
      details:
        "A high-performance color-change PPF available in satin, matte, gloss, and bold custom finishes. Restyle your Rivian while protecting your original paint underneath, backed by a 12-year warranty.",
    },
  ],
  benefitsAsAccordion: true,

  /* Front Range Package — serviceBoxes-style card row (boat-detailing/Ford
     Truck/Tesla pattern). Card 1 = WordPress's real "The Front Range
     Package" section, including its intro/closing sentences. Card 2 =
     ...
     real sources — genuine Rivian photos for both cards, no brand bleed
     here (unlike Tesla/Ford Truck's package sections). */
  packageImg: "/images/vehicles/Rivian-ceramic-coating.png",
  packageH2: "Rivian’s Best Defense — The Front Range Package",
  packageIncludes: [
  ...
  packageCards: [
    {
      ...
      footer: [
        "Designed specifically for luxury performance vehicles like Rivians, this package is the best way to protect against chips, scratches, UV damage, and road chemicals—while enhancing gloss, depth, and ease of maintenance.",
      ],
    },
    {
      image: "/images/vehicles/Rivian-4-1024x576.webp",
      imageAlt: "Rivian car detailing including paint protection film (PPF) or clear bra, window tinting, ceramic coating, vinyl wraps and more",
      eyebrow: "Get a Custom Rivian Paint Protection Quote",
      title: "custom quote",
      intro:
        "Ready to safeguard and elevate your Rivian? Request a custom quote today and tell us what you need. Which services you’re interested in:",
      bullets: [
  ...
  tintImg: "/images/vehicles/Rivian-window-tint.png",
  tintH2: "Rivian Window Tinting in Englewood, CO",
  tintBenefits: [
    {
  ...
  faqs: [
    {
      ...
      answer:
        "Most modern Rivians have a softer clear coat, so PPF and ceramic coating are highly recommended to protect it.",
    },
    {
  ...
  /* Secondary intro — image left, text right, echoing the primary heading.
     ...
     photo, a body paragraph, the pull-quote, and CTA buttons. The
     decorative photo here is a genuine Rivian photo — no brand bleed. */
  secondaryIntro: {
    eyebrow: "Colorado’s Rivian PPF & Ceramic Coating Experts",
    h2: "Premier Rivian Paint Protection in Englewood, CO",
    body: "At Front Range Detail Studio in Englewood, CO, we specialize in preserving the beauty, performance, and value of your Rivian. Whether you own the adventure-ready R1T or the innovative R1S SUV, our dedicated team offers precision paint protection film (PPF), ceramic coatings, and ceramic window tint services—all designed for Colorado’s demanding driving conditions.",
    quote:
      "We’re not just protecting paint — we’re protecting your investment.",
    img: "/images/vehicles/Rivian-1024x768.webp",
  },
  ...
  /* Case study — text left, image grid right. Images are WordPress's exact
     ...
     from the BMW Detailing page and never corrected for this Rivian page).
     Body copy replaced with accurate Rivian text, matching WP's real
     2-sentence structure (main narrative + bolded "The result?" line). */
  caseStudy: {
    h2: "See Our Rivian Paint Protection in Action",
    body: "We recently completed a full Front Range Package on a Rivian R1T — featuring a custom-fit SunTek Reaction PPF install across the front end, completely shielding it from rock chips and road debris. We followed up with a multi-layer ceramic coating on all painted surfaces and wheels, then finished it off with full ceramic window tint for heat rejection and UV protection.",
    resultLine:
      "The result? A bold, head-turning, chip-resistant, and maintenance-friendly Rivian built to thrive on Colorado roads and look flawless doing it.",
    images: [
