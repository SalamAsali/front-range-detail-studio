...
export const metadata: Metadata = {
  title: "Tesla Detailing - PPF, Ceramic Coating & Window Tint",
  description:
    "Colorado's Tesla PPF & ceramic coating experts. Paint protection film, ceramic coating, and window tint for Model 3, Model Y, Model X & Model S in Englewood, CO.",
};

const serviceCards = [
  {
    title: "Tesla Ceramic Coating",
    image: "/images/vehicles/tesla-ceramic-coating.png",
    href: "/ceramic-coating",
  },
  {
    title: "Tesla Paint Protection Film",
    image: "/images/vehicles/tesla-ppf.png",
    href: "/paint-protection-film-ppf",
  },
  {
    title: "Tesla Window Tint",
    image: "/images/vehicles/tesla-window-tint.png",
    href: "/window-tint",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "Most modern Teslas have a softer clear coat, especially Tesla models like the Model 3 and Model Y. PPF and ceramic coating are highly recommended to protect against rock chips, swirl marks, and environmental damage common on Colorado roads.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, we do custom installs for all special Tesla trim and aftermarket parts. Whether it's a carbon fiber spoiler, custom wheels, or aftermarket body kit, we can create precision-cut PPF patterns for complete coverage.",
  },
];
...
export default function TeslaDetailingPage() {
  return (
    <>
      <Hero
        image="/images/vehicles/tesla-ppf.png"
        imageAlt="Tesla paint protection film (PPF) aka clear bra mockup"
        title="Colorado's Tesla PPF & Ceramic Coating Experts"
        subtitle="Tesla Paint Protection & Restyling in Englewood, CO"
      ...
      <Section bg="dark">
        <SectionHeading>
          Premier Tesla Paint Protection in Englewood, CO
        </SectionHeading>
        <p className="text-white/70 leading-relaxed mb-6">
          At Front Range Detail Studio in Englewood, CO, we specialize in
          preserving the beauty, performance, and value of your Tesla. Whether
          you own a sleek Model 3, a versatile Model Y, a powerful Model X, or
          a flagship Model S, our dedicated team offers precision paint
      ...
      <Section bg="dark">
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-primary mb-3">Custom-Fit Tesla-Specific PPF</h3>
            <p className="text-white/70 leading-relaxed">
              Custom-fit patterns tailored to your Tesla&apos;s exact body lines,
              from aerodynamic bumpers to smooth side panels. Our precision
              digital cutting ensures seamless coverage for every Tesla model.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              your Tesla, ensuring perfect fitment with minimal seams.
            </p>
          </div>
      ...
      <Section bg="black">
        <SectionHeading>
          Tesla&apos;s Best Defense &mdash; The Front Range Package
        </SectionHeading>
      ...
      {/* Ceramic Coating */}
      <Section bg="dark">
        <SectionHeading>Tesla Ceramic Coating In Englewood</SectionHeading>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              bead off effortlessly. Perfect for keeping your Tesla looking
              showroom-fresh.
            </p>
          </div>
          <div>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              sacrificial layer that protects your Tesla&apos;s paint for years.
            </p>
          </div>
          <div>
      ...
      <Section bg="black">
        <SectionHeading>
          Tesla Window Tinting in Englewood, CO
        </SectionHeading>
        <div className="space-y-6">
          <div>
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              heat&mdash;critical for protecting Tesla&apos;s large glass roof
              panels and preserving interior materials.
            </p>
          </div>
          <div>
            <h3 className="text-primary mb-3">Privacy &amp; Aesthetic Boost</h3>
            <p className="text-white/70 leading-relaxed">
              Enhances the sleek look of your Tesla while providing privacy and
              reducing glare for a more comfortable driving experience.
            </p>
          </div>
          <div>
            <h3 className="text-primary mb-3">
            ...
            <p className="text-white/70 leading-relaxed">
              100% compatible with Tesla&apos;s Autopilot cameras, sensors, and
              driver-assist systems. Our ceramic tint won&apos;t interfere with
      ...
      <Section bg="dark" wide id="contact">
        <SectionHeading>
          Get a Custom Tesla Paint Protection Quote
        </SectionHeading>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="space-y-6">
            <p className="text-white/70 leading-relaxed">
              Whether you drive a Model 3, Model Y, Model X, or Model S,
              we&apos;ll create a custom protection package tailored to your
              Tesla. Contact us today for a free, no-obligation quote.
            </p>
